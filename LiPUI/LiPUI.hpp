...
namespace LiPUI
{
	...
	void __CloseMenuObject(StaticFunctionTag* _)
	{
		LiPUIMenu::CloseMenu();
	}
	...
	void Register(VirtualMachine* vm)
	{
		...
		vm->RegisterFunction(new NativeFunction0("__CloseMenuObject", PluginAPIExport::EXPORT_PAPYRUS_SCRIPT, __CloseMenuObject, vm));
		vm->SetFunctionFlags(PluginAPIExport::EXPORT_PAPYRUS_SCRIPT, "__CloseMenuObject", IFunction::kFunctionFlag_NoWait);
